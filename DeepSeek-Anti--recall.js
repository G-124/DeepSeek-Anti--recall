...
// @namespace    https://github.com/G-124/DeepSeek-Anti--recall
// @version      2026-02-12
...
(function() {
    ...
    const config = {
        CONTAINER_SELECTOR: 'div:has(>div>div.ds-markdown)',  // 消息列表容器
        TARGET_PATTERN: '.ds-markdown:last-of-type',          // 最新 AI 回答内容块
        TARGET_THOUGHT_PATTERN: null,                         // 禁用思考过程
        BUTTON_CONTAINER: 'div:has(>#chat-input)+div',
        CHECK_INTERVAL: 2000,
        MIN_LENGTH: 20
    };
    ...
    function onResponse(req) {
        ...
        } else if (req.__reqType == "generate") {
